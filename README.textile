...
<pre>
	$ cd /mnt
	$ bash trendingtopics/lib/scripts/run_daily_trends.sh s3n://MYBUCKET/wikistats/pagecounts-200906* s3n://MYBUCKET/wikistats/pagecounts-2009053*
</pre>
...
<pre>
	s3cmd put /mnt/daily_trends.txt s3://MYBUCKET/archive/20090606/daily_trends.txt
